...
export function askDeepSeek(params: AskParams): Promise<AnswerResult> {
  return askOpenAiCompatible(params, { baseUrl: 'https://api.deepseek.com/v1', providerLabel: 'DeepSeek' })
}
